...
class SegmentedClustersArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SegmentedClustersArray(null);
  ...
  static datatype() {
    ...
    return 'my_pcl_tutorial/SegmentedClustersArray';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SegmentedClustersArray(null);
...
module.exports = SegmentedClustersArray;
